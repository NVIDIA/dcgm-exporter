...
// Source: github.com/NVIDIA/dcgm-exporter/pkg/dcgmexporter (interfaces: Collector)
//
// Generated by this command:
//
//	mockgen -destination=mocks/pkg/dcgmexporter/mock_expcollector.go github.com/NVIDIA/dcgm-exporter/pkg/dcgmexporter Collector
//
...
func (m *MockCollector) GetMetrics() (dcgmexporter.MetricsByCounter, error) {
	m.ctrl.T.Helper()

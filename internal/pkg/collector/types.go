...
type Metric struct {
	...
	// GPUComputeInstanceID becomes the GPU_CI_ID metric label for compute-instance metrics.
	GPUComputeInstanceID string                  `json:"gpu_compute_instance_id,omitempty"`

...
// TestLabelFilterCacheLRUEviction tests that the cache properly evicts least recently used entries.
func TestLabelFilterCacheLRUEviction(t *testing.T) {
...
// TestLabelFilterCacheLRUOrdering tests that cache maintains proper LRU ordering.
func TestLabelFilterCacheLRUOrdering(t *testing.T) {
...
// TestLabelFilterCacheConcurrentAccess tests that the cache is safe for concurrent use.
func TestLabelFilterCacheConcurrentAccess(t *testing.T) {

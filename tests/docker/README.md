...
- `nvidia/dcgm-exporter:4.4.1-4.6.0-ubuntu22.04`
- `nvidia/dcgm-exporter:4.4.1-4.6.0-ubi9`
- `nvidia/dcgm-exporter:4.4.1-4.6.0-distroless`
...
IMAGE_UBUNTU=nvcr.io/nvidia/k8s/dcgm-exporter:4.4.1-4.6.0-ubuntu22.04 \
make docker-test-ubuntu
...
| `FULL_VERSION` | `4.4.1-4.6.0` | Combined DCGM and exporter version (updated by root Makefile) |
...
FULL_VERSION=4.4.1-pr-1234 \
make docker-test-ubuntu

# Compare two versions
IMAGE_UBUNTU=nvidia/dcgm-exporter:4.4.1-4.6.0-ubuntu22.04 \
...
make update-version \
  ...
  NEW_DCGM_VERSION=4.4.1 \
  OLD_EXPORTER_VERSION=4.5.0 \
  NEW_EXPORTER_VERSION=4.6.0

# This will update FULL_VERSION in tests/docker/Makefile from 4.3.0-4.5.0 to 4.4.1-4.6.0
```

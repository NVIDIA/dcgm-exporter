...
//
//	mockgen -destination=./mock_collector.go -package=dcgmexporter -copyright_file=../../hack/header.txt . Collector
//

// Package dcgmexporter is a generated GoMock package.

...
// Source: github.com/NVIDIA/dcgm-exporter/pkg/dcgmexporter (interfaces: Transform)
//
// Generated by this command:
//
//	mockgen -destination=./mock_transformator.go -package=dcgmexporter -copyright_file=../../hack/header.txt . Transform
//

...
- The platform of the container (e.g: distroless, ubuntu26.04)
...
The Ubuntu variant is intended for debugging and support; distroless is the production image published to NGC.
